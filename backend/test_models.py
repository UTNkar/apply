...
class TestMemberMethods(TestCase):
    ...
    def test_find_user_by_ssn_user_not_found(self):
        ...
        found_user = Member.find_user_by_ssn('199901010000')  # Valid format but doesn't exist
    ...
    def test_find_user_by_ssn_none_input(self):
        ...
        with self.assertRaises(AttributeError):  # .strip() on None raises AttributeError
